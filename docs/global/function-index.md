...
| F-005 | 团队空间 Agent 任务对话与历史看板 | AgentSpace / Agent 任务与对话协作 | 草稿 | `docs/function-design/F-005-team-agent-task-conversation-and-history-board.md` | R-0630 核心功能，支持团队成员在团队空间内新建 Agent 对话任务，调用外部 agent core，并查看任务历史、询问、输出和文档 diff。 |
...
| 2026-06-04 | 新增 R-0630 核心 Agent 任务对话需求 | 新增 F-005 团队空间 Agent 任务对话与历史看板，明确 AgentSpace 调用外部 agent core 的边界。 |
