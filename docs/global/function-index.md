...
| F-005 | 团队空间 Agent 任务创建与运行 | AgentSpace / Agent 任务与对话协作 | 草稿 | `docs/function-design/F-005-team-agent-task-creation-and-runtime.md` | R-0630 核心功能，支持团队成员新建 Agent 对话任务，生成 Harness 快照，调用外部 agent core，继续历史对话，维护对话名称，并处理 Agent 询问；US-005-007 `/` Agent 功能选择和 US-005-008 `@` 知识文件引用后移至 R-0730。 |
...
| 2026-06-05 | 调整 F-005 输入增强交付版本 | 将 US-005-007 `/` Agent 功能选择和 US-005-008 `@` 知识文件引用后移至 R-0730，R-0630 不执行对应测试点。 |
